...
export default function Experiment() {
    ...
    return <div className="p-10">
        ...
        <div className="p-4 w-36">
            <WSelect options={[{id: '1', text: '选项1'}, 
                {id: '2', text: '选项2'}, {id: '3', text: '选项3'}, {id: '4', text: '选项4'}, 
                {id: '5', text: '选项5'}, {id: '6', text: '选项6'}, {id: '7', text: '选项7'}, 
                {id: '8', text: '选项8'}, {id: '9', text: '选项9'}, {id: '10', text: '选项10'},
